...
#include "../../ecs/components/society_member.hpp"
...
namespace dl
{
  ...
  void SocietyGenerator::generate_members(const int seed, const Society& society, entt::registry& registry) const
  {
    ...
    registry.emplace<SocietyMember>(member1, "adam", "otomi", "Adam", SocialClass::None, Metier::None);
    ...
    registry.emplace<SocietyMember>(member2, "eve", "otomi", "Eve", SocialClass::None, Metier::None);
