...
//   //     TextureCoordsIndex, 2, GL_FLOAT, GL_FALSE, m_vertex_size, (GLvoid*)offsetof(VertexData,
//   texture_coordinates));
...
//   if (tile.frame_data->angle == FrameAngle::Parallel)
//   {
//     m_vertices[m_vertices_index++] = VertexData{glm::vec3{x + size.x, y, z}, uv_coordinates[1], texture_index,
//     color};
//   }
//   else
//   {
