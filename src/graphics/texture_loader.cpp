...
TextureLoader::TextureLoader (const std::string& filepath, const TextureType type)
  : AssetLoader (AssetType::TEXTURE), m_filepath (filepath), m_type (type), m_mode (TextureMode::SINGLE), m_horizontal_frames (1), m_vertical_frames (1)
{
}

// Load uniform texture atlas
TextureLoader::TextureLoader (const std::string& filepath, const TextureType type, const int horizontal_frames, const int vertical_frames)
  : AssetLoader (AssetType::TEXTURE), m_filepath (filepath), m_type (type), m_mode (TextureMode::UNIFORM_ATLAS), m_horizontal_frames (horizontal_frames),
